...
var me = new Student('Romelyn Ungab', 36, 'Information Technology');
console.log(me.getDescription());

var other = new Traveler('Romelyn Ungab', 36, 'Philippines');
console.log(other.getGreeting());

var other1 = new Traveler(undefined, undefined, 'Nowhere');
